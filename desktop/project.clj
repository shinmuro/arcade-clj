(defproject arcade-clj "0.0.1-SNAPSHOT"
  :description "[ArcadeRS](http://jadpole.github.io/arcaders/arcaders-1-0) を play-clj で実装してみた"
  ...
  :aot [arcade-clj.core.desktop-launcher]
  :main arcade-clj.core.desktop-launcher)
